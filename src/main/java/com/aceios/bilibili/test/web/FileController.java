...
import com.aceios.bilibili.test.entity.TFileInfo;
...
public class FileController {
    ...
    @PostMapping
    public TFileInfo upload(MultipartFile file) throws Exception {
        ...
        return new TFileInfo(localFile.getAbsolutePath());
    }
