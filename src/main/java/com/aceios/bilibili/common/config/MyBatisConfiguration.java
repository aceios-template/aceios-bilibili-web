...
//        Resource[] mapperXml;
//        try {
//            mapperXml = resolver.getResources("classpath:mappings/**/*.xml");
...
//
//        // 设置别名包
//        sqlSessionFactoryBean.setTypeAliasesPackage("com.aceios.bilibili");
//
...
//        mapperScannerConfigurer.setBasePackage("com.aceios.bilibili");
